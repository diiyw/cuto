...
type RemoteObject struct {
	...
	// Object type.
	// Possible value: object,function,undefined,string,number,boolean,symbol,bigint,
	Type	string	`json:"type"`
	
	// Object subtype hint. Specified for `object` type values only.
	// Possible value: array,null,node,regexp,date,map,set,weakmap,weakset,iterator,generator,error,proxy,promise,typedarray,arraybuffer,dataview,
...
type ObjectPreview struct {
	...
	// Object subtype hint. Specified for `object` type values only.
	// Possible value: array,null,node,regexp,date,map,set,weakmap,weakset,iterator,generator,error,
	Subtype	string	`json:"subtype"`
...
type PropertyPreview struct {
	...
	// Possible value: object,function,undefined,string,number,boolean,symbol,accessor,bigint,
	Type	string	`json:"type"`
